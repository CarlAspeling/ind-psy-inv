...
@section('title', 'Dashboard - RIASEC Career Assessment')
...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600">Manage your career assessment history and track your progress.</p>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-gray-900">Total Assessments</h3>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-900">Assessment History</h2>
            </div>
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by taking your first career interest assessment.</p>
                    <div class="mt-6">
                        <a href="{{ route('questionnaire.start', 1) }}" 
